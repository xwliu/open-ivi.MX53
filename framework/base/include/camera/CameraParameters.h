...
public:
    ...
    static const char PIXEL_FORMAT_RGB888[];
    ...
    // TokenWireless Project Tractor definition for the mulitple input source for the CSI interface and input source is have valid signal
    static const char TW8832_INPUT_SOURCE[];
    static const char TW8832_INPUT_VALID[];
