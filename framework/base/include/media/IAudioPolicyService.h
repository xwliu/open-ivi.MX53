...
public:
	...
	virtual status_t setFMChannel(bool on) = 0;
	virtual status_t setRoute(int channel, bool on) = 0;
	virtual int getIVIAudioLibVersionH() = 0;
	virtual int getIVIAudioLibVersionL() = 0;
	virtual int adjustHardwareVolume(int directions) = 0;
	virtual int muteAll(int mute) = 0;
	virtual int popLess(int mute) = 0;
	virtual int shutdownMute(int mute) = 0;
	virtual int isMute() = 0;
	virtual int muteMic(int mute) = 0;
	virtual int isMicMute() = 0;
	virtual int a2dpHolding(int holding) = 0;
