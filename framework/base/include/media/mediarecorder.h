...
enum audio_source {
    ...
    IVI_AUDIO_SOURCE_IN_FM = 8,
	IVI_AUDIO_SOURCE_IN_MPEG = 9,
	IVI_AUDIO_SOURCE_IN_CMMB = 10,
	IVI_AUDIO_SOURCE_IN_IPOD = 11,
	IVI_AUDIO_SOURCE_IN_AUX1 = 12,
	IVI_AUDIO_SOURCE_IN_AUX2 = 13,
	IVI_AUDIO_SOURCE_IN_BT_A2DP = 14,
	IVI_AUDIO_SOURCE_IN_BT_HFP = 15,
	IVI_AUDIO_SOURCE_IN_MIC = 16,

    AUDIO_SOURCE_MAX = IVI_AUDIO_SOURCE_IN_MIC,
