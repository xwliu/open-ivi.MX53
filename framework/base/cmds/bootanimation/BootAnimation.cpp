...
{     
	...
	LOGD("$$$play");
	if (mp->setDataSource("/system/etc/aging_M16_22k.wav", NULL) == NO_ERROR) {
		LOGD("$$$play 111");
...
bool BootAnimation::android()
{
	...
	initTexture(&mAndroid[0], mAssets, "images/bootlogo.png");
