...
namespace android{
    ...
    public:
	 ...
	 virtual CAPTURE_DEVICE_ERR_RET DevSetSource(struct capture_config_t *pCapcfg);
	 virtual CAPTURE_DEVICE_ERR_RET DevGetInputValid(int* result);	
    ...
    protected:
	 ...
	 virtual CAPTURE_DEVICE_ERR_RET V4l2SetSource(struct capture_config_t *pCapcfg);
	 virtual CAPTURE_DEVICE_ERR_RET V4l2GetInputValid(struct capture_config_t *pCapcfg, int* result);	
