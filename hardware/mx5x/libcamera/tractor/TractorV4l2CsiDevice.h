...
#define ENUM_SUPPORTED_FMT     1

#define CAMERA_MPEG		    "mpeg"
#define CAMERA_CMMB		    "cmmb"
#define CAMERA_BCAM		    "bcam"
...
class V4l2CsiDevice : public V4l2CapDeviceBase{
	...
	CAPTURE_DEVICE_ERR_RET V4l2SetSource(struct capture_config_t *pCapcfg);	
	CAPTURE_DEVICE_ERR_RET V4l2GetInputValid(struct capture_config_t *pCapcfg, int* result);	
