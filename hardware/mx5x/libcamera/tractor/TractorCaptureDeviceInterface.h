...
namespace android {
    ...
    public:
	 ...
	 virtual CAPTURE_DEVICE_ERR_RET DevSetSource(struct capture_config_t *pCapcfg)=0;
	 virtual CAPTURE_DEVICE_ERR_RET DevGetInputValid(int* result)=0;	
