...
#include <dirent.h>
#include "TractorV4l2CapDeviceBase.h"
...
namespace android{
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: DevSetSource(struct capture_config_t *pCapcfg){
        ...
        if (mCameraDevice <= 0){
            ...
            return V4l2SetSource(pCapcfg);
        }
    }
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: DevGetInputValid(int* result)
    {
        ...
        if (mCameraDevice <= 0){
            ...
            return V4l2GetInputValid(&mCapCfg, result);
        }
    }
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: V4l2SetSource(struct capture_config_t *pCapcfg){
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: V4l2GetInputValid(struct capture_config_t *pCapcfg, int* result){
    ...
    CAPTURE_DEVICE_ERR_RET V4l2CapDeviceBase :: V4l2Close(){
        ...
        if (mCameraDevice <= 0 ){
            CAMERA_HAL_ERR("the device handle is error");
            return CAPTURE_DEVICE_ERR_BAD_PARAM;
        }
