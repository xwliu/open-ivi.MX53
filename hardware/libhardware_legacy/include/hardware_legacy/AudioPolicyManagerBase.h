...
//#include <hardware_legacy/IVIAudioPolicyBase.h>
//#include <hardware_legacy/IVIAudioPolicyZty.h>
...
public:
		...
		virtual status_t setRoute(int channel, bool on);
		virtual int getStreamIndex(int channel);
...
protected:
        ...
        virtual bool needsDirectOuput1(AudioSystem::stream_type stream,
                                    uint32_t samplingRate,
                                    uint32_t format,
                                    uint32_t channels,
                                    AudioSystem::output_flags flags,
        ...
        audio_io_handle_t mMpegInput;                   //mpeg input handler
        audio_io_handle_t mCmmbInput;                   //cmmb input handler
        audio_io_handle_t mAux1Input;                   //aux1 input handler
        audio_io_handle_t mAux2Input;                   //aux2 input handler
		...
		//IVIAudioPolicyBase mOEMPolicyBase;
		//IVIAudioPolicyZty *mOEMPolicyZty;
