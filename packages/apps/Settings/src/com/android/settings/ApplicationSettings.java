...
import android.provider.SettingStore;
import android.provider.SettingStore.SettingItem;
...
/*
        ...
        */
        Intent intent = new Intent(SettingStore.SettingItem.SETTING_PACKAGE_NAME);
 	intent.putExtra(SettingStore.SettingItem.SETTING_ITEM_TYPE, SettingStore.SettingItem.SETTING_TYPE_APPLICATION_MANAGER);
