...
public class PhoneApp extends Application implements AccelerometerListener.OrientationListener {
    ...
    public void onCreate() {
        ...
        if (phone == null) {
            ...
            //    Log.w(LOG_TAG, "HSP AG and HFP AG Start in Phone...");
            //    mBtHandsfree = new BluetoothHandsfree(this, mCM);
            //    startService(new Intent(this, BluetoothHeadsetService.class));
            //} else {
            	   // tractor is not support HSP AG ROLE and HFP AG ROLE
            	   // So we just simulat to the phone app that we are not bluetooth capable...
                // Device is not bluetooth capable
                Log.w(LOG_TAG, "HSP AG and HFP AG Not Support for Tractor");
		   mBtHandsfree = null;
            //}
