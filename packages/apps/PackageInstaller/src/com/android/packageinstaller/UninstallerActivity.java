...
public class UninstallerActivity extends Activity implements OnClickListener,
    ...
    private static final int DLG_UNINSTALL_NOT_ALLOW = DLG_BASE + 3;
    ...
    public Dialog onCreateDialog(int id) {
        ...
        case DLG_APP_NOT_FOUND :
            return new AlertDialog.Builder(this)
                    ...
                    .create();
        case DLG_UNINSTALL_NOT_ALLOW :
            return new AlertDialog.Builder(this)
                    .setTitle(R.string.app_uninstall_not_allow_dlg_title)
                    .setIcon(com.android.internal.R.drawable.ic_dialog_alert)
                    .setMessage(R.string.app_uninstall_not_allow_dlg_text)
                    .setNeutralButton(getString(R.string.dlg_ok), 
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    finish();
    ...
    public void onCreate(Bundle icicle) {
        ...
        if(mAppInfo == null || errFlag) {
            ...
            showDialog(DLG_APP_NOT_FOUND);
        } else if(packageName.contains("tokenwireless") ||packageName.contains("com.android.calendar") || packageName.contains("zty.little") ){
            Log.e(TAG, "PreInstalled Application Uninstall Not Allow " + packageName);
            showDialog(DLG_UNINSTALL_NOT_ALLOW);
        } else {
