...
public class LauncherModel extends BroadcastReceiver {
	...
	//yishan
	private static final String DATA_APP_SCAN_DONE = "data_app_scan_done";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if(DATA_APP_SCAN_DONE.equals(action)) {
			Log.d(TAG, "DATA_APP_SCAN_DONE");
			//loadAndBindAllAppsForce();
			startLoader(mApp, false);   //yishan
		}
    }
	...
	//yishan: load apps when data/app is scan done
	public void loadAndBindAllAppsForce() {
		if (DEBUG_LOADERS) {
			Log.d(TAG, "$$loadAndBindAllAppsForce111");
		}
		
		mLoaderTask.loadAndBindAllAppsForce();
	}
    ...
    private class LoaderTask implements Runnable {
        ...
        public void loadAndBindAllAppsForce() {
            if (DEBUG_LOADERS) {
                Log.d(TAG, "$$loadAndBindAllAppsForce");
            }
